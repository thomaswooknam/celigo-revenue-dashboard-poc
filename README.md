# celigo-revenue-dashboard-poc
An executive sales revenue and pipeline health dashboard built on audited CRM data using DuckDB and Tableau
...
We hypothesize that cross-departmental reporting discrepancies are **not** caused by technical connection failures, but by a combination of **sales team behavioral shortcuts** and **legacy CRM system reuse architecture**. Specifically, we theorize that:
